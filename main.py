...
# Bot commands (keep your existing commands the same)
@bot.command()
async def join(ctx):
    """Join voice channel"""
...
# ... keep all your other commands the same (pause, resume, stop, skip, queue, leave, ping, volume, nowplaying, help_bot)
